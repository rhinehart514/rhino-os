...
- `dimension:` names which sub-score (delivery/craft/viability) the move targets
...
- Moves should target the weakest dimension specifically:
  - Low delivery_score → "code doesn't deliver what the claim promises"
  - Low craft_score → "error handling, edge cases, robustness"
