...
| Viability | 10% | agents | Would this survive the market? |
...
| All three (code-only) | delivery 60%, craft 40% |
...
**Hard caps:**
- No market-context.json AND no customer-intel.json = capped at 30
- market-context.json only = capped at 60
- Both sources present = full range 0-100
